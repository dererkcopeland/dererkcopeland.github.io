import { education, gridItems } from "@/Data";
    ...
    return (
      <CardContainer className="inter-var col-span-1 md:col-span-2">
        <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full h-full rounded-xl p-6 border flex flex-col items-center">
          <CardItem translateZ="50" className="justify-center text-xl font-bold text-neutral-600 dark:text-white">
            {title}
          </CardItem>
          ...
          <CardItem translateZ="100" rotateX={20} rotateZ={-10} className="w-full mt-4">
            <img
              ...
              height="1000"
              width="1000"
              className="h-60 md:h-80 w-full object-cover rounded-xl group-hover/card:shadow-xl mx-auto" // Added mx-auto
              alt="thumbnail"
            />
          </CardItem>
        </CardBody>
